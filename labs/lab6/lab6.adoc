= Lab 6 - Installing Red Hat CloudForms
...
httpd-1-pr4m9        0/1       Running   0          12m
...
==== <<../lab5/lab5.adoc#lab5,Previous Lab: Lab 5 - Expanding the OpenShift Container Platform Cluster>>
