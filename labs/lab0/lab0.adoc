...
| link:https://instructor.labs.sysdeseng.com/rhte/managing-ocp-install-beyond.pem[https://instructor.labs.sysdeseng.com/rhte/managing-ocp-install-beyond.pem]
| Username: student +
Password: INSTRUCTOR WILL PROVIDE
|======================
