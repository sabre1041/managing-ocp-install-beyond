...
image::../lab0/images/managing-ocp-overview/3.png[]
...
==== <<../lab1/lab1.adoc#lab1,Previous Lab: Ansible Tower Self-Configure and OCP Install>>
==== <<../lab3/lab3.adoc#lab3,Next Lab: Reviewing OpenShift Installation>>
