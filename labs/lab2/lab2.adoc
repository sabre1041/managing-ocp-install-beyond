...
==== <<../lab1/lab1.adoc#lab1,Previous Lab: Lab 1 - Ansible Tower Self-Configure and OCP Install>>
==== <<../lab3/lab3.adoc#lab3,Next Lab: Lab 3 - Reviewing OpenShift Installation>>
