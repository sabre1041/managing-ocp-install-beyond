...
sleep 10
rm -rf /var/lib/libvirt/images/master-clone.qcow2
rm -rf /var/lib/libvirt/images/node-1-clone.qcow2
rm -rf /var/lib/libvirt/images/node-2-clone.qcow2
virsh undefine master-clone
virsh undefine node-2-clone
virsh undefine node-1-clone
