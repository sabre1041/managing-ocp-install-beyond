# RHTE 2017: Managing the Operation of an OpenShift Cluster
...
=== <<labs/lab4/lab4.adoc#lab4,Lab 4 - Installing Red Hat CloudForms>>
=== <<labs/lab5/lab5.adoc#lab5,Lab 5 - Managing the Lifecycle of an Application>>
=== <<labs/lab6/lab6.adoc#lab6,Lab 6 - Expanding the OpenShift Container Platform Cluster>>
